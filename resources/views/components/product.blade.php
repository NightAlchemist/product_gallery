        ...
        <div class="container mx-auto px-6 py-3">
            <div class="flex items-center justify-between">
                <div class="hidden w-full text-white md:flex md:items-center">
                    ...
                    <span class="mx-1 text-sm">Bogotá</span>
                </div>
        ...
        <div class="container mx-auto px-6">
            <div class="md:flex md:items-center">
                ...
                <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                    ...
                    <hr class="my-3">
                    <div class="mt-2">
                        <label class="text-white font-semibold text-sm" for="count">Count:</label>
                        <div class="flex items-center mt-1">
                            <button class="text-gray-500 focus:outline-none focus:text-gray-600">
                                <svg class="h-5 w-5" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                            </button>
                            <span class="text-gray-400 text-lg mx-2">20</span>
                            <button class="text-gray-500 focus:outline-none focus:text-gray-600">
                                <svg class="h-5 w-5" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                            </button>
                        </div>
                    ...
                    <div class="mt-3">
                        <label class="text-white font-semibold text-sm" for="count">Color:</label>
                        <div class="flex items-center mt-1">
                    ...
                    <div class="flex items-center mt-6">
                        ...
                        <button class="mx-2 text-white border rounded-md p-2 hover:bg-gray-200 focus:outline-none">
            ...
            <div class="max-w-6xl mx-auto mt-6">
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 mb-4">
                    <ul class="flex flex-wrap -mb-px" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                        <li class="mr-2" role="presentation">
                            <button class="inline-block text-gray-500 hover:text-gray-600 hover:border-gray-300 rounded-t-lg py-4 px-4 text-sm font-medium text-center border-transparent border-b-2 dark:text-gray-400 dark:hover:text-gray-300" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Product Information</button>
                        </li>
                        <li class="mr-2" role="presentation">
                ...
                <div id="myTabContent">
                    <div class="bg-gray-50 p-4 rounded-lg dark:bg-gray-800 hidden" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <p class="text-gray-500 dark:text-gray-400 text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores, alias aperiam deleniti, cum iusto consequatur minus ipsa dolore fuga qui autem tempore voluptatum libero eaque, dolor id architecto deserunt harum.</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg dark:bg-gray-800" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                        <p class="text-gray-500 dark:text-gray-400 text-sm">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Necessitatibus qui porro odit, deleniti sint, numquam accusamus, in rem distinctio ab a veritatis! Id nulla molestiae necessitatibus rerum. Deserunt, magni ab!</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg dark:bg-gray-800 hidden" id="settings" role="tabpanel" aria-labelledby="settings-tab">
                        <p class="text-gray-500 dark:text-gray-400 text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit, dolor. Possimus, aspernatur at dolore ipsum laudantium quae quo debitis sint error omnis culpa vero, itaque saepe aliquam magni enim sed!</p>
                    </div>                    
                </div>
            ...
            <div class="mt-16">
                <h3 class="text-white text-2xl font-medium">Related Products</h3>
                <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
                    <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                        ...
                        <div class="px-5 py-3">
                            <h3 class="text-gray-400 uppercase">Chanel</h3>
                    ...
                    <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                        ...
                        <div class="px-5 py-3">
                            <h3 class="text-gray-400 uppercase">Man Mix</h3>
                            <span class="text-gray-500 mt-2">$12</span>
                        </div>
                    </div>
                    <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                        ...
                        <div class="px-5 py-3">
                            <h3 class="text-gray-400 uppercase">Classic watch</h3>
                            <span class="text-gray-500 mt-2">$12</span>
                        </div>
                    </div>
                    <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                        ...
                        <div class="px-5 py-3">
                            <h3 class="text-gray-400 uppercase">woman mix</h3>
                            <span class="text-gray-500 mt-2">$12</span>
                        </div>
                    </div>
                </div>

...
<body>
    ...
    <div class="">        
        <nav class="flex" aria-label="Breadcrumb">
            ...
            <li>
                ...
                <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Products</a>
                </div>
            </li>
            <li>
                @yield('header')
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        ...
        <a href="products" class="flex items-center">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Kimble</span>
        </a>
    ...
    <footer class="footer footer-center  w-full p-4 bg-gray-300 text-gray-800">
        ...
        <p>
            Copyright © 2023 -
            <a class="font-semibold" href="mailto:jhoaof@kimble.com"
            >Kimble</a
            >
        </p>
        </div>
